...
public class User extends MachineFrame {
    ...
    public User() {
        frame();
        label.setText("<html>這裡要先輸入你想查詢的年月份發票兌獎號碼，但有以下幾點必須注意： <br/>" +
                "(1) 當月份的發票會在下個奇數月的25號才開獎，務必確認好是否已到開獎日期。 <br/>" +
                "   e.g. 1/1的發票會在3/25才開獎，因此在3/24仍然找不到1月的發票兌獎號碼。 <br/>" +
                "(2) 查詢方式只要輸入民國年和奇數月即可。 <br/>" +
                "   e.g. 若想查詢民國110年3月至4月的兌獎號碼，則輸入11003即可，無需補上04。 <br/>" +
                "(3) 要注意年月有沒有打錯。 <br/>" +
                "   e.g. 月份不會超過12、年份不會超過今年的年份。 <br/>" +
                "(4) 根據財政部提供的資料，可追溯到101年5月的兌換號碼。（110.6.28註） <br/>" +
                "   只不過發票的兌換期限只有半年，查心酸的。 <br/>" +
                "以上若沒有遵守都會被判定輸入格式錯誤</html>");
